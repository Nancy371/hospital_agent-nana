    ...
    },
    {
        ...
        "logic": {
            "all_of": [
                ...
                {"any_of": ["right_to_left_shunt", "pulmonary_vascular_shunt", "pulmonary_avm_mechanism"]},
                {"any_of": ["pulmonary_cta_positive", "enhanced_ct_vascular_malformation", "bubble_echo_right_to_left_shunt"]},
            ]
        },
        "output": {
